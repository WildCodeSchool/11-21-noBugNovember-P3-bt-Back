...
// return console.log(req.query)
    const {kindofexpert, price, practice, industry, jobtitle, geo, lang, yoe, cie, pastcie, feedback, key} = req.query
    const sqlValues = []
